                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        <select name="class_id" id="class_id" class="form-control" / required>
							...
							<?php if($row['class_id'] == $class['class_id']) echo 'selected="selected"';?>><?php echo $class['name'];?> </option>
                            <?php endforeach;?>
                        </select>
                ...
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $this->crud_model->get_type_name_by_id('class', $type['class_id']);?>
                                </td>
