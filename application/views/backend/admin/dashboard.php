                            ...
                            <div class="r-icon-stats">
                                ...
                                ?>
								   ...
								   <?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?> <?php echo $expense_amount;?>
                                    ...
                                    <span class="text-muted"><a href="#"><?php echo get_phrase('Expense');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                $income_amount = $query->row()->amount; ?>
                                   <h4 class="text-uppercase">
                                    ...
                                    <span class="text-muted"><a href="#" ><?php echo get_phrase('Income');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
								   ...
								   <?php echo $this->db->count_all_results('admin');?>
                                    ...
                                    <span class="text-muted"><a href="#" ><?php echo get_phrase('Admin');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                   <h4>
                                    ...
                                    <span class="text-muted"><a href="#" ><?php echo get_phrase('Attendance');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
