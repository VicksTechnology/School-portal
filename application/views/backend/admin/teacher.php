                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <?php if($teacher['role']== 2) echo 'Subject Teacher';?>
                            ...
                            <a href="<?php echo base_url();?>admin/edit_teacher/<?php echo $teacher['teacher_id'];?>/TeacherName=<?php echo $teacher['name'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-edit"></i></button></a>
                            ...
                            <a href="<?php echo base_url();?>admin/printTeacherInformation/<?php echo $teacher['teacher_id'];?>/TeacherName=<?php echo $teacher['name'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-print"></i></button></a>
                            </td>
                        </tr>
