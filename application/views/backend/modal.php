	...
	function showAjaxModal(url){
		...
		jQuery('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="<?php echo base_url();?>assets/images/straight-loader.gif" /></div>');
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top:100px;">
				...
				<div class="row">
				 ...
				 <div class="col-sm-5">	
                    <a href="#" class="btn btn-danger btn-sm" id="delete_link2"><i class="fa fa-check">&nbsp;</i>Yes</a>
                    <button type="button" class="btn btn-info btn-sm" data-dismiss="modal"><i class="fa fa-times">&nbsp;</i>No</button>
					</div>
				</div>
				</div>
            </div>
